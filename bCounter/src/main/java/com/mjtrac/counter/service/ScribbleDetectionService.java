...
public class ScribbleDetectionService {
    ...
    private String outlineDir;   // blank = scribbles/ subfolder of reportOutputDir;
    
    /** Same reports.output.dir VoteTallyService uses for results_report.html,
     *  overvote_report.txt, etc. — outline images land in a "scribbles"
     *  subfolder of this directory when scanner.scribble-outline-dir is blank.
     */
    @Value("${reports.output.dir:${user.home}/pbss_data/reports}")
     ...
     * directory (scanner.scribble-outline-dir),  or in a "scribbles" subfolder
     * of reports.output.dir if that property is blank.
     *
	...
	return Paths.get(reportOutputDir, "scribbles");
    }
