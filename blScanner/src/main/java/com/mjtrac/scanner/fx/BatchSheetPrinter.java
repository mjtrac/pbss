 ...
 * human-readable datetime — for the current scan batch. Same
 * java.awt.print approach as scanner's (Swing) BatchSheetPrinter — plain
 * AWT printing works fine from a JavaFX app, no javafx.print needed. A
 * manual, user-clicked action (shows the system print dialog), distinct
 * from scanner-core's FlagPagePrinter (automatic, off-by-default, one page
 * per individual note).
 */
