...
SETUP
-----
Keep pbss.app in the SAME FOLDER as:
  election-ballot-system/
  election-counter/

Example layout:
  MyElectionFolder/
    pbss.app          ← double-click this
    election-ballot-system/
    election-counter/
...
Or right-click pbss.app → Open → Open (bypasses Gatekeeper once).
...
Both are written to the same folder as pbss.app.
