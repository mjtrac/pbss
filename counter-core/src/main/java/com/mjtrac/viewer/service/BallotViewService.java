...
public class BallotViewService {
    ...
    public static class BallotView {
        ...
        private static String resolveImagePath(String path) {
            ...
            // VoteRecordService renames successfully-counted images by
            // appending ".counted" to the full original filename (not
            // replacing its extension) — e.g. "foo.png" -> "foo.png.counted".
            String counted = path + ".counted";
