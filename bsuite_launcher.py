#!/usr/bin/env python3
"""
bsuite_launcher.py — Cross-platform GUI launcher for bSuite.
...
Usage:        python3 bsuite_launcher.py
              Place this script in the bSuite/ root folder, next to bBuilder/
              and bCounter/.
"""
...
def find_suite_dir() -> Path | None:
    """Find the bSuite root — the folder containing bBuilder/ and bCounter/."""
...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        hdr.pack(fill="x")
        tk.Label(hdr, text="bSuite Launcher",
        ...
        self._log_msg(f"bSuite root: {SUITE_DIR}")
